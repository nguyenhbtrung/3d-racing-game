...
public class CarAudio : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (m_StartedSound)
        {
            ...
            float pitch = ULerp(lowPitchMin, lowPitchMax, m_CarController.EngineRPM / m_CarController.ShiftGearMaxRPM);
            ...
            else
            {
                ...
                accFade = Mathf.Abs((m_CarController.Vertical > 0 ) ? m_CarController.Vertical : 0);
